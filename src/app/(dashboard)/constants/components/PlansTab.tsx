  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
      ...
      <div className="flex items-center gap-3 border-b border-white/5 pb-4">
        ...
        <div>
          <h2 className="text-lg font-bold text-white">پلان‌های اشتراک و اعتبار</h2>
          <p className="text-sm text-white/40">
            مدیریت سطوح دسترسی شعب، بسته‌های اعتباری هوش مصنوعی و قیمت‌ها
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {plans === undefined ? (
              ...
              plans.map((plan: Doc<"plans">) => (
                ...
                >
                  {plan.is_base && (
                    <div className="absolute -top-3 -right-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 px-3 py-1 font-black text-xs text-white shadow-lg shadow-emerald-500/20 transform -rotate-6 border border-emerald-300/50">
                      پایه
                    </div>
                  )}
